...
class NetworkTask3 {
  ...
  NetworkTask3._() : _network = HttpClient();

  static final NetworkTask3 _instance = NetworkTask3._();
  factory NetworkTask3() => _instance;

  void close() => _network.close();
  // DOMAIN
  String baseUrl3 = "jsonplaceholder.typicode.com";

  // APIS
  String apiAlbums3 = "/todos";
